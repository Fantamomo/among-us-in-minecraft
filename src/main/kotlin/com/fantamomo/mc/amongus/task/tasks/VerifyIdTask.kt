...
object VerifyIdTask : Task<VerifyIdTask, VerifyIdTask.AssignedVerifyIdTask> {
    ...
    class AssignedVerifyIdTask(
    ...
    ) : GuiAssignedTask<VerifyIdTask, AssignedVerifyIdTask>(), BotSupportingTask {
        ...
        override fun getTaskDurationForBot() = BotSupportingTask.BotTaskDuration.percentage(6135.milliseconds, 5)
