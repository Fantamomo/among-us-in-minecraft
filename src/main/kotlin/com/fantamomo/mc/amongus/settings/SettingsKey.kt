...
data class SettingsKey<T : Any, S : SettingsType<T>>(
    ...
    object ROLES : SettingsGroup("roles", Material.DIAMOND) {
        ...
        val MORPHLING_MORPH_COOLDOWN = key("morphling.morph.cooldown", DurationSettingsType.min(5.seconds), 30.seconds)
        val GHOST_FORM_COOLDOWN = key("ghost.form.cooldown", DurationSettingsType.min(1.seconds), 30.seconds)
        val GHOST_FORM_DURATION = key("ghost.form.duration", DurationSettingsType.min(1.seconds), 20.seconds)
    }
